...
public:
    ...
    // constructor
    SVDD() = delete;
    SVDD(const std::function<double(const std::vector<double>, const std::vector<double>, const std::vector<double>)> K_=kernel::rbf, const std::vector<double> params_={1.0}, const bool verbose_=true);
